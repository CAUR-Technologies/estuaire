...
// pre-setted to known.
template<typename T, std::size_t D, bool BC>
void FMM_FirstOrder(const ArrayDescriptor <agsis::vect<double, D>, 1, BC> &seeds,
         ArrayDescriptor<MarchingTag, D, BC> &tag,
         const ArrayDescriptor<T, D, BC> &viscosity,
         OrthogonalGrid<T, D, BC> &arrival)
{
    ...
    while(it != band.end())
    {
        ...
        for (int i = D - 1; i >= 0; i--)
        {
            FMM_UpwindSolve<FirstOrderSemiFiniteDifference, BACKWARD>(index + arrival.strides[i], tag, viscosity, arrival, band, i);
            FMM_UpwindSolve<FirstOrderSemiFiniteDifference, FORWARD>(index - arrival.strides[i], tag, viscosity, arrival, band, i);
        }
...
template<typename T, std::size_t D, bool BC>
void IFMM_FirstOrder(ArrayDescriptor<MarchingTag, D, BC> &tag,
          const ArrayDescriptor<T, D, BC> &viscosity,
          OrthogonalGrid<T, D, BC> &arrival)
{
    using namespace agsis;
...
// pre-setted to known.
template<typename T, std::size_t D, bool BC>
void FMM_SecondOrder(const ArrayDescriptor <agsis::vect<double, D>, 1, BC> &seeds,
         ArrayDescriptor<MarchingTag, D, BC> &tag,
         const ArrayDescriptor<T, D, BC> &viscosity,
         OrthogonalGrid<T, D, BC> &arrival)
{
    ...
    while(it != band.end())
    {
        ...
        for (int i = D - 1; i >= 0; i--)
        {
            FMM_UpwindSolve<SecondOrderSemiFiniteDifference, BACKWARD>(index + arrival.strides[i], tag, viscosity, arrival, band, i);
            FMM_UpwindSolve<SecondOrderSemiFiniteDifference, FORWARD>(index - arrival.strides[i], tag, viscosity, arrival, band, i);
        }
...
template<typename T, std::size_t D, bool BC>
void IFMM_SecondOrder(ArrayDescriptor<MarchingTag, D, BC> &tag,
          const ArrayDescriptor<T, D, BC> &viscosity,
          OrthogonalGrid<T, D, BC> &arrival)
{
    using namespace agsis;
...
//
template<typename T, std::size_t D, bool BC>
void inline FMM2(const ArrayDescriptor <agsis::vect<double, D>, 1, BC> &seeds,
                    ArrayDescriptor<MarchingTag, D, BC> &tag,
                    const ArrayDescriptor<T, D, BC> &viscosity,
...
template<typename T, std::size_t D, bool BC>
void inline IFMM2(ArrayDescriptor<MarchingTag, D, BC> &tag,
                    const ArrayDescriptor<T, D, BC> &viscosity,
                    OrthogonalGrid<T, D, BC> &arrival, bool second_order = true)
{
    if (second_order)
...
template<typename T, std::size_t D, bool BC>
void inline FMM3(const ArrayDescriptor <agsis::vect<double, D>, 1, BC> &seeds,
                    ArrayDescriptor<MarchingTag, D, BC> &tag,
                    const ArrayDescriptor<T, D, BC> &viscosity,
                    OrthogonalGrid<T, D, BC> &arrival, bool second_order = true)
{
...
template<typename T, std::size_t D, bool BC>
void inline IFMM3(ArrayDescriptor<MarchingTag, D, BC> &tag,
                    const ArrayDescriptor<T, D, BC> &viscosity,
                    OrthogonalGrid<T, D, BC> &arrival, bool second_order = true)
{
    if (second_order)
